            ...
            <div class="card-body">
                <form class="form-horizontal layui-form">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="sqprice" value="<?php echo $row['sqprice']?>" placeholder="输入该应用的卡密销售价格" class="form-control" lay-verType="tips" lay-verify="required">
                    </div>
                    <div class="form-group mb-3">
                        <label for="example-input-normal" style="font-weight: 500">应用代理商销售价格：</label>
                        <input type="text" name="sqsprice" value="<?php echo $row['sqsprice']?>" placeholder="输入该应用的代理商销售价格" class="form-control" lay-verType="tips" lay-verify="required">
                    </div>
                    <div class="form-group mb-3">
                        <label for="example-input-normal" style="font-weight: 500">应用超管销售价格：</label>
                        <input type="text" name="cgprice" value="<?php echo $row['cgprice']?>" placeholder="输入该应用的超管销售价格" class="form-control" lay-verType="tips" lay-verify="required">
                    </div>
                    <div class="form-group mb-3">
                        <label for="example-input-normal" style="font-weight: 500">应用代理商添加卡密价格：</label>
                        <input type="text" name="sqprice2" value="<?php echo $row['sqprice2']?>" placeholder="输入该应用的代理商添加卡密的价格" class="form-control" lay-verType="tips" lay-verify="required">
                        <small>价格应低于卡密销售价格</small>
                    </div>
                    <div class="form-group mb-3">
                        <label for="example-input-normal" style="font-weight: 500">应用超管添加卡密价格：</label>
                        <input type="text" name="sqprice3" value="<?php echo $row['sqprice3']?>" placeholder="输入该应用的超管添加卡密的价格" class="form-control" lay-verType="tips" lay-verify="required">
                        <small>价格应低于代理商添加卡密价格</small>
                    </div>
                    <div class="form-group mb-3">
                        <label for="example-input-normal" style="font-weight: 500">应用超管添加代理商价格：</label>
                       <input type="text" name="sqsprice2" value="<?php echo $row['sqsprice2']?>" placeholder="输入该应用的超管添加代理商的价格" class="form-control" lay-verType="tips" lay-verify="required">
